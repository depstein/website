...
export class ProjectsComponent implements OnInit {
  ...
  filterPublications() {
  	this.practicesPublications = this.allPublications.filter((pub:{}) => {
  		return ['chi26e', 'chi26d', 'chi25c', 'cscw24a', 'chi24d', 'chi23a', 'cscw22b', 'chi22a', 'cscw21a','jmh21','dis21b','chi21a', 'chi21b', 'cscw20b', 'chi17a', 'chi16c', 'ubi15', 'chi15'].includes(pub['key']);
  	});
