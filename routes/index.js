...
var bib_data = fs.readdirSync(BIB_FILES).map(function(f) { if(f.toString().endsWith('.bib')){return formatBib(f, bibtex(fs.readFileSync(BIB_FILES + '/' + f, 'utf-8'))); } else {return null;} }).filter(Boolean);
